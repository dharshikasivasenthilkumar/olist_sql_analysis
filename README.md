...
~Categories and states with very few orders (fewer than 30) were excluded from the review-score and delivery-performance rankings, to avoid small-sample noise producing misleadingly extreme results.
